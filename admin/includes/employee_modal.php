            ...
            <form class="form-horizontal" method="POST" action="employee_add_grades.php">
               ...
               <?php
                  ...
                  while($criterio = $queryCriterios->fetch_assoc()){
                    echo '<h4 class="text-center"><b>'.$numCriterio.'. '.$criterio['nombre_criterio'].'</b></h4>
                          <div style="display: flex; justify-content: center;">
                    ...
                    while($subcriterio = $querySubcriterios->fetch_assoc()){
                      echo '<div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <input type="text" class="form-control text-center" name="criterio'.$subcriterio['id'].'" id="criterio'.$subcriterio['id'].'">
                              </div>
                            </div>';
                    }
