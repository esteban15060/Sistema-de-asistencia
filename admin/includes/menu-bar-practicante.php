         ...
         <form method="post" action="home-practicante.php" class="form__ver-perfil">
            ...
            <button type="submit" class="enlaces__btn" id="button1">
               <a class="enlaces" href="#" id="button1">
                  ...
                  <h6 class="text-center text-light letraNavBar" style="width: 120px; margin-left: 15px;">ESTADISTICAS Y
                     LOGROS</h6>
               </a>
            </button>
         </form>
         ...
         <form method="post" action="calendario-practicante.php" class="form__ver-perfil">
            ...
            <button type="submit" class="enlaces__btn" id="button1">
               <a class="enlaces" href="#" id="button1">
                  ...
                  <h6 class="text-center text-light letraNavBar" style="width: 110px; margin-left: 20px;">CALENDARIO O
                     AGENDA</h6>
               </a>
            </button>
         </form>
         ...
         <form method="post" action="buzon.php" class="form__ver-perfil">
            ...
            <button type="submit" class="enlaces__btn" id="button1">
               <a class="enlaces" href="#" id="button1">
                  ...
                  <h6 class="text-center text-light letraNavBar" style="width: 110px; margin-left: 20px;">BUZON DE
                     SUGERENCIAS</h6>
               </a>
            </button>
         </form>
