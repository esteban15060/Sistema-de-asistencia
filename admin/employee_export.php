                    ...
                    while($row = $query->fetch_assoc()){
                      ?>
                        <tr>
                          ...
                          <td>
                          <button><a href="excel_practicantes.php?negocio=<?php echo $row['employee_id']; ?>" class="btn btn-success btn-sm btn-flat"><span class="glyphicon glyphicon-cloud-download"></span> Reporte en Excel</a></button>
