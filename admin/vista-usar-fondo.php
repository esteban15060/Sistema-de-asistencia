...
if (isset($_GET['id'])) {
  ...
  $stmt = $pdo->prepare("SELECT * FROM fondo WHERE id = ?");
  $stmt->execute([$id]);
  $imagen = $stmt->fetch();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $stmt = $pdo->prepare("UPDATE fondo SET  nombre = ? WHERE id = ?");
  $stmt->execute([ $rutaImagen, $id]);
              ...
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <?php if ($imagen['nombre']): ?>
                    ...
                    <p>Imagen actual:</p>
                    <img src="<?='fondo/'. $imagen['nombre'] ?>" alt="Imagen actual" style="max-width: 300px;">
                  <?php endif; ?><br><br>
